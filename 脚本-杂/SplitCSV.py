...
if __name__ == "__main__":
    infile = r"D:\users\kfwang\pAnno\human\chrtest\output\10aaGT-AG\test_anno.panno"
    out_path = r"D:\users\kfwang\pAnno\human\chrtest\output\10aaGT-AG\res_part"
    part_num = 3
    GetPep (infile, out_path, part_num)